...
const normalizeSource = (source) => {
  ...
  /*
   * Category/About section form ke possible source names.
   */
  if (
...
const AdminChatbot = () => {
  ...
  const [filterSource] = useState("Chatbot");
  ...
  const getListTitle = () => {
    ...
    if (filterSource === "Course Request") {
      return "Category & About Form Inquiries";
    }
  ...
  const getEmptyMessage = () => {
    ...
    if (filterSource === "Course Request") {
      return "Category ya About section ke form se inquiry receive hone ke baad yahan show hogi.";
    }
    ...
    <AdminLayout>
      <div className="admin-content-header inquiries-page-header">
        <div className="inquiries-header-content">
          ...
          <p>
            Website chatbot se received leads manage karein.
          </p>
        </div>
